document.addEventListener('DOMContentLoaded', function () {
        ...
        tabs.forEach(tab => {
            tab.addEventListener('click', () => {
                ...
                tabPanels.forEach(panel => {
                    ...
                    if (panel.id === 'universities-tab' && !panel.dataset.initialized && panel.classList.contains('active')) {
    ...
    // --- UNIVERSITY TAB LOGIC (Rebuilt based on Majors Tab) ---
    function initializeUniversitiesTab() {
        const universitiesTab = document.getElementById('universities-tab');
        if (universitiesTab.dataset.initialized) return;
        universitiesTab.dataset.initialized = 'true';

        universitiesTab.innerHTML = `
            <div class="app-container">
                <div class="left-panel">
                    ...
                    <div class="controls-toolbar">
                        ...
                        <div id="expand-collapse-container" class="switcher-group">
                             <div class="switcher">
        ...
        const container = universitiesTab;
        ...
        // --- Full implementation of unchanged functions for Uni Tab ---
