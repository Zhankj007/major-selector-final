window.initializeMajorsTab = function() {
    ...
    // All the working logic from the final standalone Majors tool goes here,
    // carefully namespaced to the `majorsTab` container.
    ...
    async function fetchData(type) { /* ... same as before ... */ }
    function renderTree(hierarchy, type, autoExpand = false) { /* ... same as before ... */ }
    ...
    function handleCheckboxChange(checkbox) { /* ... same as before ... */ }
    function updateOutputUI() { /* ... same as before ... */ }
    function updateButtonsState() { /* ... same as before ... */ }
    function syncCheckboxesWithState() { /* ... same as before ... */ }
    function cascadeCheckboxVisuals(checkbox) { /* ... same as before ... */ }
    function showDetails(targetLi) { /* ... same as before ... */ }

    // Full implementation of all functions for Majors Tab
